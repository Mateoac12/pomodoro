...
const ProgressBar = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex relative z-0 items-center gap-1 lg:gap-4 bg-white px-4 pr-6 lg:px-10 py-2 rounded-md shadow-sm h-12 w-full">
        ...
        <h2 className="text-lg lg:text-2xl text-slate-600 ml-2 lg:ml-4">
          {timer.step}/{rules.length}
        </h2>
        <div className="absolute -right-8 lg:-right-12 h-12 lg:h-16 top-1/2 -translate-y-1/2 w-12 lg:w-16 border bg-white shadow-lg shadow-slate-200 rounded-full flex flex-col justify-center items-center">
          <h2 className="text-2xl lg:text-4xl text-slate-600">{timer.laps}</h2>
